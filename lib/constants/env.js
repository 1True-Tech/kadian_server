 ...
 * @property {"string" | undefined} CLIENT_URL
 * @property {"string" | undefined} PAYPAL_CLIENT_ID
 * @property {"string" | undefined} PAYPAL_CLIENT_SECRET
 * @property {"string" | undefined} PAYPAL_MODE
*/
...
const env = {
  ...
  CLIENT_URL: process.env.CLIENT_URL || "http://localhost:3000/checkout/success"
};
